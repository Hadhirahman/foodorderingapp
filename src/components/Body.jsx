...
const fetchdata=async()=>{ 
    ...
    setRestaurent(jsondata.data.cards[2].card.card.gridElements.infoWithStyle.restaurants)
    ...
    <div className="btn-container">
        <button className="btn" onClick={()=>{
            const filterdata =restaurent.filter((restaurentfilter)=>restaurentfilter.info.avgRatingString>4)
